---
title: React Router v7/v8
description: Using @scribe-atp/react-router-framework — loader factories for React Router v7/v8 framework (server) mode.
---

import { Aside } from '@astrojs/starlight/components';

`@scribe-atp/react-router-framework` provides loader factories for [React Router v7/v8 framework mode](https://reactrouter.com). The factories wire up `request.signal` automatically so fetches are cancelled if the user navigates away before the response arrives.
