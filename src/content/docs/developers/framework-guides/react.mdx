...
<Aside>
  For **React Router v7/v8 framework (server) mode**, use [`@scribe-atp/react-router-framework`](/developers/framework-guides/react-router) instead. For **Next.js App Router**, use [`@scribe-atp/next`](/developers/framework-guides/next).
</Aside>
